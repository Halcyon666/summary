...
If you wanna initiate a new project, you can read [this article](https://halcyon666.github.io/summary/Frontend/Integrate%20husky%20prettier%20etc), 
then install the tailwind Css by reading [this tutorial](https://tailwindcss.com/docs/installation/using-vite).
...
[example commit](https://github.com/Halcyon666/react-daily-learn/commit/419fe06cb1b05244e1dbd7e1927ba08e397b4a5f)
