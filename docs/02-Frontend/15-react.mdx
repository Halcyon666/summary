...
| ----------------------------- | --------------------------------------------- | ----------------------------------- |
| `onClick={getRecipe}`         | Default, most common                          | Pass function directly              |
| `onClick={() => getRecipe()}` | When you need to wrap logic or pass arguments | Creates a new function every render |
