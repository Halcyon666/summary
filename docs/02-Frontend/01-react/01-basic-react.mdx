...
## 插件`ES7 React/Redux/GraphQL/React-Native snippet`

输入时支持快捷键，好像idea中的`main`
...
| 类型                      | 命名风格   | 示例                            |
| ------------------------- | ---------- | ------------------------------- |
| React 组件                | PascalCase | `GameLayout.tsx`, `App.tsx`     |
| 路由 / 工具 / hook / 配置 | camelCase  | `gameRoutes.ts`, `useAuth.ts`   |
| 文件夹                    | kebab-case | `layouts/`, `routes/`, `pages/` |
