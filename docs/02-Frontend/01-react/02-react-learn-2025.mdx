...
import { reactLearn2025 } from '@site/src/data/videos';
...
<VideoProgressDashboard videos={reactLearn2025}/>
</details>
...
import { videoReactRouter } from '@site/src/data/videos';

<SingleVideoProgress video={videoReactRouter}/>
