...
- Topics:
  ...
  - Nested routes, layout routes(json and xml reusable routes)
  - useLocation
  - useSearchParams
...
import { reduxVideo } from '@site/src/data/reactVideos';

<SingleVideoProgress video={reduxVideo}/>

- 📺 [React Redux Full Course for Beginners | Redux Toolkit Complete Tutorial](https://www.youtube.com/watch?v=NqzdVN2tyvQ&t=8s)
