...
sidebar_position: 10
description: 本文整理了两种常用的测试方式： 1. 纯单元测试（Mockito + JUnit） 2. Spring Boot 测试（@SpringBootTest
  排除自动装配） 特点： - 不依赖 Spring 容器
tags:
- algorithm
- computer-science
- data-structures
...
[完整代码记录](https://github.com/Halcyon666/mybatis-plus/commit/d092b62282b1666aaaad46c46077114752a37115)

### static method mock

<details>
<summary>静态方法Mock</summary>
...
1. [System out 重定向](https://github.com/Halcyon666/learn-cases/blob/2e543cf044a8e67a0ae1cbde5fe3ab8aa5b1637e/learncases/src/test/java/com/whalefall/override/TestClassTest.java#L48)
