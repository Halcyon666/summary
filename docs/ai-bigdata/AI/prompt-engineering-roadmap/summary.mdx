...
- LangGraph / LangChain4j 编排
- RAG 策略 (Parent-Child, HyDE)
- FastAPI / Spring AI 接口封装
- 微调脚本 (LoRA/QLoRA)
...
- 结构化输出与数据契约 (OpenAPI / Spring AI)

### ⭐ 大脑: 架构思维

- 设计 Dify / Spring AI 工作流
- Router 分发策略
- 系统容错与评估体系
- 异构系统解耦 (MQ, Sidecar Pattern)
