...
| 阶段 | 周期 | 核心目标 | 文档链接 |
|------|------|----------|----------|
| [Level 1: AI-Native 工作流](./level-1-ai-native) | 第 1-2 周 | 建立 AI 优先的开发习惯,搭建本地 AI 基础设施 | → |
| [Level 2: RAG 应用开发](./level-2-rag) | 第 3-5 周 | 掌握检索增强生成 (RAG),理解异构系统架构 | → |
| [Level 3: Agent 架构](./level-3-agent) | 第 6-8 周 | 掌握智能决策与路由,建立可观测性和审计能力 | → |
| [Level 4: 全栈落地](./level-4-production) | 第 9-12 周 | 完成前后端全栈交付,掌握模型微调和生产部署 | → |
| [Prompt 质量评估与总结](./summary) | - | Prompt 质量标准、技能组合、面试突击清单 | → |
