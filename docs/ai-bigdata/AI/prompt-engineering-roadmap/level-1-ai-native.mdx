...
先建立 AI-Native 的工作习惯和本地基础设施，才能在后续阶段高效学习 RAG、Agent 等技术。
...
:::info Java 开发者提示
如果你选择 Spring AI / LangChain4j 路线，可以跳过本节。Spring AI 已经封装了 Embedding、向量检索等能力，不需要直接操作 NumPy / PyTorch。本节适合需要深入理解底层原理或使用 Python AI 生态的开发者。
:::

**学习重点**:
- **Pandas/NumPy**: 向量化计算基础 (理解 Embedding 原理)
- **PyTorch 基础**:
...
:::tip 工具关系理解
- **NumPy**: 在 CPU 上处理数字矩阵
- **PyTorch**: 在 GPU 上处理数字矩阵，多了"自动求导"（神经网络学习的核心）
- **模型 (LLM/BERT)**: 本质上是用 PyTorch 写的复杂数学公式
:::
