...
sidebar_position: 5
description: '[](https://www.microsoft.com/zh-cn/software-download/windows11) 打开解压后的
  sources文件夹，删除appraiserres.dll文件'
tags:
- books
- learning
last_update:
...
---
### 1. 下载家庭版 或者 专业版 系统文件
[Windows 11 下载页面](https://www.microsoft.com/zh-cn/software-download/windows11)
