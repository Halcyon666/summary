...
[参考文章][docker compose redis cluster]

### 编写 Redis 配置文件

> 记得将 IP 192.168.3.163 替换为你的真实 IP 地址
...
停止并删除网络 rediscluster_default 使用以下命令
...
## Docker Compose 中的 Jenkins

[本文参考][docker compose jenkins]
