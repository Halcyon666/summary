---
id: win11-release-update
title: Win11 Update Skip TPM
sidebar_label: Win11 Update Skip TPM
sidebar_position: 5
description: '[](https://www.microsoft.com/zh-cn/software-download/windows11) Open unzipped sources folder, delete appraiserres.dll file'
tags:
- books
- learning
last_update:
  ...
  author: halcyon666
---
### 1. Download Home or Pro System File
[Windows 11 Download Page](https://www.microsoft.com/zh-cn/software-download/windows11)

### 2. Delete `appraiserres.dll` File

Open the unzipped `sources` folder, delete `appraiserres.dll` file.

### 3. Modify Registry

Refer to this link to [Modify Registry](https://www.toutiao.com/article/7019926793574498819/)

### 4. Execute Bat Script

[Script from](https://www.youtube.com/watch?v=SfTAhlfRktk&t=29s)

Script Download Address 
> [Baidu Cloud](https://pan.baidu.com/share/init?surl=en1DfRC17hiB4uOC60ClXQ)
> Extraction Code `4p36`
